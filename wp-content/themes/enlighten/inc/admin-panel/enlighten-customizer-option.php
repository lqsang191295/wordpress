...
$wp_customize->add_section(
    'enlighten_action_section',
    array(
        'title' => esc_html__('Top Action Section','enlighten'),
        'priority' => 24,
        'capability' => 'edit_theme_options',
        'theme_support' => '',
        'panel' => 'enlighten_home_panel'
...
$wp_customize->add_section(
    'enlighten_product_section',
    array(
        'title' => esc_html__('Product Section','enlighten'),
        'priority' => 25,
        'capability' => 'edit_theme_options',
        'theme_support' => '',
        'panel' => 'enlighten_home_panel'
...
$wp_customize->add_section(
    'enlighten_menucustom_section',
    array(
        'title' => esc_html__('Menu Custom Section','enlighten'),
        'priority' => 26,
        'capability' => 'edit_theme_options',
        'theme_support' => '',
        'panel' => 'enlighten_home_panel'
...
$wp_customize->add_setting(
    ...
    */
    ...
    array(
        'label' => esc_html__('Enable Client','enlighten'),
        'section' => 'enlighten_product_section',
        'type' => 'checkbox',
        'priority' => 1,
    )
    );
    $wp_customize->add_setting(
    'enlighten_client_title_product',
    array(
        'default' => '',
        'transport'   => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field',
    ...
    array(
        'label' => esc_html__('Enable Client','enlighten'),
        'section' => 'enlighten_menucustom_section',
        'type' => 'checkbox',
        'priority' => 1,
    )
    );
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_one',
           array(
               'label'      => esc_html__( 'Upload Action Image One', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_one',
               'priority' => 3
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_image_one_1',
        array(
            'default' => '',
            'sanitize_callback' => 'esc_url_raw'
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_one_1',
           array(
               'label'      => esc_html__( 'Upload Action Image Hover One', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_one_1',
               'priority' => 3
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_title_one',
        array(
            'default' => '',
            'transport'   => 'postMessage',
            'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control(
        'enlighten_action_title_one',
        array(
            'label' => esc_html__('Title One','enlighten'),
            'type' => 'text',
            'section' => 'enlighten_action_section',
            'priority' => 4,
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_two',
           array(
               'label'      => esc_html__( 'Upload Action Image Two', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_two',
               'priority' => 5
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_image_two_1',
        array(
            'default' => '',
            'sanitize_callback' => 'esc_url_raw'
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_two_1',
           array(
               'label'      => esc_html__( 'Upload Action Image Hover Two', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_two_1',
               'priority' => 5
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_title_two',
        array(
            'default' => '',
            'transport'   => 'postMessage',
            'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control(
        'enlighten_action_title_two',
        array(
            'label' => esc_html__('Title Two','enlighten'),
            'type' => 'text',
            'section' => 'enlighten_action_section',
            'priority' => 6
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_three',
           array(
               'label'      => esc_html__( 'Upload Action Image Three', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_three',
               'priority' => 7
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_image_three_1',
        array(
            'default' => '',
            'sanitize_callback' => 'esc_url_raw'
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_three_1',
           array(
               'label'      => esc_html__( 'Upload Action Image Hover Three', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_three_1',
               'priority' => 8
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_title_three',
        array(
            'default' => '',
            'transport'   => 'postMessage',
            'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control(
        'enlighten_action_title_three',
        array(
            'label' => esc_html__('Title Three','enlighten'),
            'type' => 'text',
            'section' => 'enlighten_action_section',
            'priority' => 9
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_four',
           array(
               'label'      => esc_html__( 'Upload Action Image Four', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_four',
               'priority' => 10
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_image_four_1',
        array(
            'default' => '',
            'sanitize_callback' => 'esc_url_raw'
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_four_1',
           array(
               'label'      => esc_html__( 'Upload Action Image Hover Four', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
               'settings'   => 'enlighten_action_image_four_1',
               'priority' => 11
           )
       )
    );
    $wp_customize->add_setting(
        'enlighten_action_title_four',
        array(
            'default' => '',
            'transport'   => 'postMessage',
            'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control(
        'enlighten_action_title_four',
        array(
            'label' => esc_html__('Title Four','enlighten'),
            'type' => 'text',
            'section' => 'enlighten_action_section',
            'priority' => 12
        )
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_five',
           array(
               'label'      => esc_html__( 'Upload Action Image Five', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
    ...
    $wp_customize->add_control(
       new WP_Customize_Image_Control(
           ...
           'enlighten_action_image_five_1',
           array(
               'label'      => esc_html__( 'Upload Action Image Hover Five', 'enlighten' ),
               'description' => esc_html__('Suggested image dimensions: 32 x 32','enlighten'),
               'section'    => 'enlighten_action_section',
