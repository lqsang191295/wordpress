	...
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
		...
		*/
        ...
        $wp_customize->add_control( 
            ...
            array(
                'label'      => esc_html__( 'Secondary Color 123', 'enlighten' ),
                'section'    => 'colors',
                'settings'   => 'enlighten_secondary_color',
            ) ) 
        );
	//---------------
	$wp_customize->add_setting( 'enlighten_testthu_color', array( 'default' => '#E9902C', 'sanitize_callback' => 'sanitize_hex_color' ));

	$wp_customize->add_control(
	    new WP_Customize_Control(
	        $wp_customize,
	        'enlighten_testthu_color',
	        array(
	            'label'          => esc_html__( 'AAAAAAAAAAAA', 'enlighten' ),
	            'section'        => 'colors',
	            'settings'       => 'enlighten_testthu_color',
	        )
	    )
	);
}
