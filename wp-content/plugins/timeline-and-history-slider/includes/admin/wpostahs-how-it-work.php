										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="http://demo.wponlinesupport.com/timeline-and-history-slider-demo/?utm_source=hp&event=demo" target="_blank"><?php _e('Demo for Designs', 'timeline-and-history-slider'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/timeline-history-slider/?utm_source=hp&event=go_premium" target="_blank"><?php _e('Go Premium ', 'timeline-and-history-slider'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/timeline-and-history-slider-pro/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Demo ', 'timeline-and-history-slider'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/timeline-and-history-slider/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
