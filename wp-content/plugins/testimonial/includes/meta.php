                    ...
                    <div class="media-source-list expandable">
                        ...
                        foreach($media_source as $source_key=>$source_info){
							...
							<div class="items">
                                ...
                                <label>
                                <input <?php if(!empty($source_info['checked'])) echo 'checked'; ?> type="checkbox" name="testimonial_meta_options[media_source][<?php echo $source_info['id']; ?>][checked]" value="yes" />                                
