...
if ( ! defined('ABSPATH')) exit;  // if direct access
		...
		$("#testimonial-'.$post_id.' .grid-items").owlCarousel({
			...
			responsive:{
				0:{
					items:'.$items_in_mobile.',
					
				},
				600:{
					items:'.$items_in_tablet.',
...
*/;			
	...
	if($slider_autoplay=="true")
		...
		$html.= 'autoplayHoverPause: '.$hover_stop.',';	
		}	
	
				
			
	if($slider_navigation=="true"){
	...
	if(!empty($paginationSpeed)){
		...
		$html.= 'dotsSpeed: '.$paginationSpeed.',';
