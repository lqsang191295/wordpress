...
function get_search_form( $echo = true ) {
	...
	if ( '' != $search_form_template ) {
		...
		if ( 'html5' == $format ) {
			$form = '<form role="search" method="get" class="search-form u02searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform u02searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
...
function get_search_form_custome( $echo = true ) {
	/**
	 * Fires before the search form is retrieved, at the start of get_search_form().
	 *
	 * @since 2.7.0 as 'get_search_form' action.
	...
	if ( '' != $search_form_template ) {
		...
		if ( 'html5' == $format ) {
			$form = '<form role="search" name="searchForm" method="get" class="u02searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<input id="txtSearch" class="textcnt autoclear" name="s" value="' . get_search_query() . '" placeholder="' . esc_attr_x( 'Search &hellip;', 'placeholder' ) . '"
					autocomplete="off" aria-owns="awesomplete_list_1" role="combobox">
				<input class="u02searchbttn" type="submit" value="'. esc_attr_x( '', 'submit button' ) .'" />
